...
const helloAnimation = keyframes`
    0% {
...
const HelloSvg = chakra('svg', {
  base: {
    strokeDasharray: '5800px',
    animation: `${helloAnimation} linear 10s infinite`,
  },
});
...
const HelloAnimation = ({ fill = 'none', color = '#334155', strokeWidth = '35px' }: HelloAnimationProps) => {
  return (
